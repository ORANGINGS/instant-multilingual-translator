...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.4.1-1a73e8">
...
- **英文重音強調開關**：預設關閉；需要練習時再獨立開啟，單一英文單字會正常播放後再慢速重播。
...
此功能使用獨立開關且預設關閉。一般閱讀時維持關閉，只有需要練習英文發音時再手動開啟。
...
重音模式與「自動播放原文」互不綁定。即使關閉自動播放，手動按下喇叭按鈕時仍會依重音開關的狀態播放。
...
目前版本為 **1.4.1 Beta**。歡迎透過 Issue 回報錯誤或提出功能建議。
